...
function Formulario(props) {
    const {handleSubmit, handleName, handleEmail, handlePhone, handleAddress, name, email, phone, address} = props
    return (
        <div>
                <form className='form-size mx-auto mt-5' onSubmit={handleSubmit}>
                    ...
                    <div className="form-group">
                        ...
                        <input required type="text" className="form-control" id="formGroupExampleInput" placeholder="Writte your name here" onChange={handleName} value={name} />
                    </div>
                    <div className="form-group">
